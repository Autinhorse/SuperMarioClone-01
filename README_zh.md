...
现在还有一个主要的项目在搞，所以还是半业余的研究。

这个游戏做好了，Super Mario Maker的实验反到可以先放放，因为觉得就是增加内容，技术困难可能不大了。

下面想试的也是一个我想了有10年没有动手的项目，一个可以教大家玩数独的游戏。可以把数独的一些复杂技巧一步一步讲清楚，并给与专门的练习。这个游戏不需要什么美术，主要看功能的设计，也看看AI到底能不能实现这复杂的程序逻辑。
...
* [**007:** Day 11 - 告一段落](./games/ricochet/devlogs/zh/007.Day%2011%20-%20告一段落.md)
